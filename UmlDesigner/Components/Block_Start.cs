...
{
    public partial class Block_Start : Block_Template
    {
        public Block_Start()
        {
            ComponentPresets();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.FillEllipse(Dictionary.ShapeColor_Start, ShapeStart());
            FindSuitableFontAndFontSizeForText(out font, out stringSize, e, Dictionary.TextStart);
            e.Graphics.DrawString(Dictionary.TextStart, font,new SolidBrush(Color.Black),(Width - stringSize.Width) / 2, Height / 2 - stringSize.Height / 2);
        }
        /// <summary>
        /// Metoda służąca do odcięcia obszaru na zewnątrz docelowego kształtu komponentu- Przezroczystość
        /// </summary>
        protected Rectangle ShapeStart()
        {
